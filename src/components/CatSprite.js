...
import { executeQueue, messageTimer, removeMessage } from "../redux/actions";

export default function CatSprite() {
  const style = useSelector((store) => store.style);
  ...
  return (
    ...
    >
      {Boolean(style.message && style.duration) && (
        <div
          style={{
            position: "absolute",
            top: -40,
            ...
            height: 40,
            width: 120,
            borderWidth: style.messageType === "think" ? 1 : 2,
            borderColor: style.messageType === "think" ? "darkgray" : "black",
            borderStyle: "solid",
            borderRadius: 10,
            display: "flex",
